    ...
    <div className="container mx-auto p-6">
      ...
      {(role === 'accountant' || role === 'admin') && (
        <div className="grid grid-cols-2 gap-4 mt-8">
          <Link to="/fee-structure" className="bg-blue-100 hover:bg-blue-200 p-4 rounded-lg shadow-md flex flex-col items-center">
            <PlusIcon className="h-8 w-8 text-blue-600" />
            <h2 className="text-lg font-bold mt-2">Add Fee Structure</h2>
          </Link>

          <Link to="/search" className="bg-green-100 hover:bg-green-200 p-4 rounded-lg shadow-md flex flex-col items-center">
            <PencilIcon className="h-8 w-8 text-green-600" />
            <h2 className="text-lg font-bold mt-2">Edit Fee Structure</h2>
          </Link>

          {role === 'admin' && (
            <Link to="/search" className="bg-red-100 hover:bg-red-200 p-4 rounded-lg shadow-md flex flex-col items-center">
              <TrashIcon className="h-8 w-8 text-red-600" />
              <h2 className="text-lg font-bold mt-2">Delete Fee Structure</h2>
            </Link>
          )}

          <Link to="/fee-payment" className="bg-yellow-100 hover:bg-yellow-200 p-4 rounded-lg shadow-md flex flex-col items-center">
            <PlusIcon className="h-8 w-8 text-yellow-600" />
            <h2 className="text-lg font-bold mt-2">Add Fee Payment</h2>
          </Link>

          <Link to="/search" className="bg-purple-100 hover:bg-purple-200 p-4 rounded-lg shadow-md flex flex-col items-center">
