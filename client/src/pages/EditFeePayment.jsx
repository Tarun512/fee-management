...
const EditFeePaymentForm = () => {
  ...
  useEffect(() => {
    const fetchFeePayment = async () => {
      ...
      const response = await fetch(`/api/payment/get-payment/${listingId}`,{
        method: 'GET',
        headers: {
...
// handle verify
  const handleVerify = async(e)=>{
    const response = await fetch(`/api/payment/handle-verify/${formData.registerationId}`,{
      method: 'POST',
      headers: {
        'Content-type': 'application/json'
      },
...
// handle form sunbmit
  const handleSubmit = async (e) => {
    ...
    const listingId = params.id;
    try {
      const response = await fetch(`/api/payment/edit-payment/${listingId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
...
export default EditFeePaymentForm;
